...
/*** https://tema1.dokuzyazilim.com/js/fancybox/jquery.fancybox.pack.js?v=2780 ***/
...
/*** https://tema1.dokuzyazilim.com/templates/default-neo/js/js.js?v=2780 ***/
...
$(document).ready(function() {
  ...
  if ($('.neo_countdown').length > 0) {
    $('.neo_countdown').each(function () {
      var $this = $(this);
      var $number = $(this).find(".neo_countdown_number");
      var animated = false;
      $(window).scroll(function() {
        if (animated) return;
